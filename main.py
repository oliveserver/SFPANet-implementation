...
from ablation import AB1, AB2, AB3, AB4
...
use_aux = False
using_data = 1  # 0 ->VOC 1 ->Cityscape 2 ->CamVid
total_epoch = 60
...
elif using_net_num == 8:
    net=AB1(num_classes)
elif using_net_num == 9:
    net=AB2(num_classes)
elif using_net_num == 10:
    net=AB3(num_classes)
elif using_net_num == 11:
    net=AB4(num_classes)
else:
...
param_groups = [
    {"params": net.backbone.parameters(), "lr": n_gpus * 1e-5},
    {"params": other_params}
]
